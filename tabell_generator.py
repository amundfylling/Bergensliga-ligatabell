...
# serial page for Bergensligaen
SERIES_URL = "https://stiga.trefik.cz/ithf/ranking/serial.aspx?ID=220002"
...
<head>
  ...
  <title>Bergensligaen i Bordhockey – {season_label}</title>
...
<body>
  <div class="wrap">
    <h1>Bergensligaen i Bordhockey</h1>
...
"""
    ...
    <div class="foot">Generert: {datetime.now().strftime("%d.%m.%Y %H:%M")} · Bergensligaen i Bordhockey</div>
  </div>
...
def main():
    ...
    season_years = [y for y in range(start_year, current_start + 1)]
